...
class _$NoteFormEventTearOff {
  ...
  _Initialized initialized({required Option<Note> initialNoteOption}) {
    return _Initialized(
      initialNoteOption: initialNoteOption,
    );
  }

  _BodyChanged bodyChanged({required String bodyStr}) {
    return _BodyChanged(
      bodyStr: bodyStr,
    );
  }

  _ColorChanged colorChanged({required Color color}) {
    return _ColorChanged(
      color: color,
    );
  }

  _TodosChanged todosChanged({required KtList<TodoItemPrimitive> todos}) {
...
class __$InitializedCopyWithImpl<$Res> extends _$NoteFormEventCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Initialized(
      initialNoteOption: initialNoteOption == freezed
...
class _$_Initialized implements _Initialized {
  const _$_Initialized({required this.initialNoteOption});
...
abstract class _Initialized implements NoteFormEvent {
  const factory _Initialized({required Option<Note> initialNoteOption}) =
      _$_Initialized;
...
class _$_BodyChanged implements _BodyChanged {
  const _$_BodyChanged({required this.bodyStr});
...
abstract class _BodyChanged implements NoteFormEvent {
  const factory _BodyChanged({required String bodyStr}) = _$_BodyChanged;
...
class _$_ColorChanged implements _ColorChanged {
  const _$_ColorChanged({required this.color});
...
abstract class _ColorChanged implements NoteFormEvent {
  const factory _ColorChanged({required Color color}) = _$_ColorChanged;
...
class _$_TodosChanged implements _TodosChanged {
  const _$_TodosChanged({required this.todos});
...
abstract class _TodosChanged implements NoteFormEvent {
  const factory _TodosChanged({required KtList<TodoItemPrimitive> todos}) =
      _$_TodosChanged;
