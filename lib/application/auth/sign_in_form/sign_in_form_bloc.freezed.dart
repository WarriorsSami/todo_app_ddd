...
mixin _$SignInFormState {
  ...
  Password get password =>
      throw _privateConstructorUsedError; // for showing the progress bar
  bool get isSubmitting =>
      throw _privateConstructorUsedError; // for fetching the back-end's response
  Option<Either<AuthFailure, Unit>> get authFailureOrSuccessOption =>
      throw _privateConstructorUsedError; // for enabling auto-validation for the input fields
...
class _$_SignInFormState implements _SignInFormState {
  ...
  @override // for showing the progress bar
  final bool isSubmitting;
  @override // for fetching the back-end's response
  final Option<Either<AuthFailure, Unit>> authFailureOrSuccessOption;
  @override // for enabling auto-validation for the input fields
// and showing the error messages
